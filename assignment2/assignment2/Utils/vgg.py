...
class Vgg16(object):
    def __init__(self, input_tensor, is_training):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            self.conv6 = slim.conv2d(self.pool5, 4096, [7, 7], scope='vgg_16/fc6')
            self.conv7 = slim.conv2d(self.conv6, 4096, [1, 1], scope='vgg_16/fc7')
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        pool7_value = sess.run(vgg.conv7, feed_dict = {input_tensor: x})
